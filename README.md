...
Holochain hApp for collaborative data tables.
...
You'll have the `tables.webhapp` in `workdir`. This is what you should distribute so that the Holochain Launcher can install it.
You will also have its subcomponent `tables.happ` in the same folder`.
